                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="username_elearning" id="username_elearning" autocomplete="off" placeholder="Username" required>
                        </div>
                        <div class="col-md-6 mt-3">
                            <label for="password" class="form-label">Password</label>
                            <div class="input-group mb-3">
                                <input type="password" class="form-control password" name="password_elearning" id="password" autocomplete="off" placeholder="Password" required>
