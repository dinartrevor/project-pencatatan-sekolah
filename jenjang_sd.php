...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && empty($_POST['id_siswa'])) {
    try {
        ...
        header("Location: jenjang_sd.php");
        exit();
...
<html lang="en">
    <head>
        ...
        <title>Data Siswa Jenjang SD</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Siswa Jenjang SD</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="data_guru.php"> Siswa Jenjang SD</a></li>
                            <li class="breadcrumb-item active">List Siswa Jenjang SD</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <!-- Button to Open the Modal -->
                                 <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-create">
                                           <i class="fas fa-plus"></i> Tambah Data Siswa Jenjang SD
                                        </button>
