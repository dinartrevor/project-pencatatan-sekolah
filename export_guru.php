...
$header = ['No', 'Nama Guru', 'NIK', 'Tempat Lahir', 'Tanggal Lahir', 'Agama', 'No. Handphone', 'Mata Pelajaran','Pendidikan Terakhir', 'Jabatan', 'Jenis Kelamin', 'Status']; // Contoh header, sesuaikan dengan kolom tabel Anda
