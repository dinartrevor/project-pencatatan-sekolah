...
<html lang="en">
    <head>
        ...
        <title>Data Jenjang SD (Grade 2)</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Jenjang SD ( Grade 2)</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Dykhanza Ukhtiya Azzahra</td>
                                            <td>Al-Jazari</td>
                                            <td>Laki-Laki</td>
                                            <td></td>
                                            <td>2025/2026</td>
                                        ...
                                        <tr>
                                            <td>Muhammad Bagas </td>
                                            <td>Al-Jazari</td>
                                            <td>Laki-Laki</td>
                                            <td>SD AL-AZHAR 70</td>
                                            <td>2025/2026</td> 
                                        </tr>
                                        <tr>
                                            <td>M. Riski Ananda Budi</td>
                                            <td>Al-Jazari</td>
                                            <td>Laki-Laki</td>
                                            <td></td>
                                            <td>2025/2026</td>
