                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.php">Data Ipad</a>
                                    <a class="nav-link" href="layout-sidenav-light.php">Data E-learning</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data E-learning</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Data E-Learning</li>
                        </ol>
                        <div class="card mb-4">
                                <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Data E-Learning Guru 
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>emilda qotrunda</td>
                                            <td>qotrun@gmail.com</td>
                                            <td>12345</td>
                                        </tr>
                                    </tbody>
                                </table>
