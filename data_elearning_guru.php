...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && empty($_POST['id_elearning'])) {
    try {
        ...
        header("Location: data_elearning_guru.php");
        exit();
...
<html lang="en">
    <head>
        ...
        <title>Data E-Learning Guru</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data E-Learning Guru</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="data_elearning_guru.php">E-Learning Guru</a></li>
                            <li class="breadcrumb-item active">List E-Learning Guru</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <!-- Button to Open the Modal -->
                                 <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-create">
                                           <i class="fas fa-plus"></i> Tambah Data E-Learning Guru
                                        </button>
                                        <a href="<?= 'export_elearning.php?type='."Guru".'' ?>" id="exportExcelBtn" class="btn btn-success">
