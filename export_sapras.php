...
$header = ['No', 'Nama Barang', 'Merek', 'Jumlah', 'Keterangan']; // Contoh header, sesuaikan dengan kolom tabel Anda
...
foreach ($data as $key => $row) {
    ...
    $rowDataToWrite[] = $row['nama_barang'];
    $rowDataToWrite[] = $row['merek'];
    $rowDataToWrite[] = $row['qty'];
    $rowDataToWrite[] = $row['keterangan'];
...
$filename = 'Data_Sapras_' . date('YmdHis') . '.xlsx';
