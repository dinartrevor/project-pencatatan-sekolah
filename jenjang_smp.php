            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Jenjang SMP</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Lutfhia Nisrina Izzatunnisa</td>
                                            <td>7 Ar-Rahman</td>
                                            <td>Perempuan</td>
                                            <td>SD 4 OKU</td>
                                            <td>2025/2026</td>
