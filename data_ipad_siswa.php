...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && empty($_POST['id_apple'])) {
    try {
        ...
        $_SESSION['message_success'] = 'Data Ipad Siswa Berhasil ditambahkan';
        header("Location: data_ipad_siswa.php");
        exit();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['id_apple']) {
    try {
        ...
        $_SESSION['message_success'] = 'Data Ipad Siswa Berhasil diupdate';
        header("Location: data_ipad_siswa.php");
        exit();
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Ipad Siswa</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="data_ipad_guru.php">Ipad Siswa</a></li>
                            <li class="breadcrumb-item active">List Ipad Siswa</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <!-- Button to Open the Modal -->
                                 <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-create">
                                           <i class="fas fa-plus"></i> Tambah Data Ipad Siswa
                                        </button>
                                        <a href="<?= 'export_ipad.php?type='."Siswa".'' ?>" id="exportExcelBtn" class="btn btn-success">
